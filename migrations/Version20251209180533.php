 ...
 */
final class Version20251209180533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE statistic (id INT AUTO_INCREMENT NOT NULL, date DATETIME DEFAULT NULL, nb_clients INT DEFAULT NULL, nb_reservations INT DEFAULT NULL, total_revenue DOUBLE PRECISION DEFAULT NULL, top_services JSON DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
